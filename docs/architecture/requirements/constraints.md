...
| C-02 | The minimum Go version is 1.26, the oldest release Go still patches. | `go.mod` | Standard-library features up to 1.26 are available to every build, including `http.CrossOriginProtection` (1.25). Raised when Go stops supporting the floor. |

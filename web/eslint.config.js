...
export default tseslint.config(
  ...
  ...tseslint.configs.recommended,
  {
    ...
    rules: {
      ...
      // jsx-a11y/recommended — keyboard navigation, alt text, ARIA
      // roles, label/control association. Cheap to add now; expensive
      // to retrofit once the UI ships publicly.
